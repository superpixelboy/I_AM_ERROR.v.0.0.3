...
if (knockBack >= 20) 
{
	...
	with(instance_create_layer(x,y,layer,o_green_beetle_knockback))
	{
		/*old uppercut
...
else if(knockBack >0)
{
		...
		with(instance_create_layer(x,y,layer,o_green_beetle_knockback_small))
	{
		//direction = other.hitfrom;
		//show_debug_message("directoin =" + direction);
	//	hsp = lengthdir_x(5,direction);
...
if(hitTimer == 0){
    if (!place_meeting(x,y+1,o_wall))
    {
        ...
        image_speed = 1;
        sprite_index = s_green_beetle_idle;
