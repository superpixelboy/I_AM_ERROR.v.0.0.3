/// Step Event or Knockback Script for the small green_beetle knockback
...
if (done == 0) {
    ...
    if (place_meeting(x, y + vsp, o_wall)) {
        ...
        with (instance_create_layer(x, y, layer, o_green_beetle)) {
            hp = other.hp;
            if (sign(other.hsp) != 0) {
...
// -------------------------------------
// Timer-based transformation into o_green_beetle
// -------------------------------------
timer--;
if (timer < 0) {
    with (instance_create_layer(x, y, layer, o_green_beetle)) {
